...
![](teal-insights-logo.png){fig-alt="Teal Insights Logo" fig-align="center"}
...
This book is an active project, evolving in real-time. We're embracing an open development process, building it publicly using R & [Quarto](https://quarto.org/). All code, content, and revisions are [available on GitHub](https://github.com/Teal-Insights/teal-insights-guide-to-wbids) for transparency and collaboration.
